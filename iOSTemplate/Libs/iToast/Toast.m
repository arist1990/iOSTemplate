...
- (id)initWithText:(NSString *)text_{
    if (self = [super init]) {
        ...
        CGSize textSize = [text boundingRectWithSize:CGSizeMake(ScreenWidth-130, MAXFLOAT) options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:font} context:nil].size;
